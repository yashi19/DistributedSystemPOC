...
import org.dist.simplekafka.{ConsumeRequest, ConsumeResponse, PartitionInfo, TopicMetadataRequest, TopicMetadataResponse}

class MySimpleConsumer(bootstrapBroker: InetAddressAndPort, socketClient:MySocketClient = new MySocketClient) extends Logging {
