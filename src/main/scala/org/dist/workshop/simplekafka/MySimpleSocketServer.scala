...
class MySimpleSocketServer(val brokerId: Int,
                         val host: String,
                         val port: Int,
                         val kafkaApis: MySimpleKafkaApi) extends Logging {
...
class TcpListener(localEp: InetAddressAndPort, kafkaApis: MySimpleKafkaApi, socketServer: MySimpleSocketServer) extends Thread with Logging {
