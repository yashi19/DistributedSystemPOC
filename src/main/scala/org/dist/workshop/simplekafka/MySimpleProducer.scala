...
import org.dist.simplekafka.{PartitionInfo, ProduceRequest, ProduceResponse, TopicMetadataRequest, TopicMetadataResponse}

class MySimpleProducer(bootstrapBroker: InetAddressAndPort, socketClient: MySocketClient = new MySocketClient) extends Logging {
